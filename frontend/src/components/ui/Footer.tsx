...
const Footer = () => {
	return (
		<>
		<footer class="bg-primary text-white dark:bg-gray-900">
				...
				<div class="lg:flex lg:items-start lg:gap-8">
					...
					<div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
						<div class="col-span-2">
							<div>
								<h2 class="text-2xl font-bold text-white dark:text-white">Analytix</h2>
						...
						<div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
							<form class="w-full">
								...
								<div
									class="border rounded-lg border-gray-100 p-2 focus-within:ring-0 sm:flex sm:items-center sm:gap-4 dark:border-gray-800"
								>
									<input
										type="email"
										id="UserEmail"
										placeholder="john@rhcp.com"
										class="w-full border-none outline-none focus:outline-none focus:border-none focus:ring-0 focus-within:ring-0 focus-visible:ring-0 sm:text-sm dark:bg-gray-900 dark:text-white"
									/>

									<button
										class="mt-1 border w-full bg-white px-6 py-3 text-sm font-bold rounded-lg tracking-wide text-primary transition-all hover:bg-primary hover:border-white hover:border hover:text-white sm:mt-0 sm:w-auto sm:shrink-0"
									>
										Register
									</button>
								</div>
						...
						<div class="col-span-2 sm:col-span-1">
							<p class="font-medium text-white dark:text-white">Downloads</p>
				...
				<div class="mt-8 border-t border-gray-100 pt-8 dark:border-gray-800">
					<div class="sm:flex sm:justify-between">
						<p class="text-xs text-white dark:text-gray-400">
							&copy; 2022. Analytix. All rights reserved.
						</p>
